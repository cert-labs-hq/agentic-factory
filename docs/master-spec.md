...
*   **Mandatory Capture:** EVERY interaction (markdown prompts, free-text chat, or ad-hoc tasks) MUST be recorded in `/.factory/telemetry.json` as the final action of the session.
